      ...
      var n = o(2957),
        ...
        s = function (t) {
          ...
          var e = t.active,
            ...
            r = {};
          return (
            (r.controlbar = (function (t) {
              if (t || e || o || n) {
                var i = {};
                return (
                  (t = t || {}),
                  (i.iconsActive = t.iconsActive || e),
                  (i.icons = t.icons || o),
                  (i.text = t.text || o),
                  (i.background = t.background || n),
                  i
                );
              }
            })(t.controlbar)),
            (r.timeslider = (function (t) {
              if (t || e) {
                var o = {};
                return (
                  (t = t || {}),
                  (o.progress = t.progress || e),
                  (o.rail = t.rail),
                  (o.buffer = t.buffer),
                  !o.buffer &&
                    o.progress &&
                    (o.buffer = (0, i.HY)(o.progress, 50)),
                  (o.knob = t.knob || o.progress),
                  (o.ads = t.ads || n),
                  o
                );
              }
            ...
            (r.menus = (function (t) {
              if (t || e || o || n) {
                ...
                return (
                  (t = t || {}),
                  (i.text = t.text || o),
                  (i.textActive = t.textActive || e),
                  (i.background = t.background || n),
                  i
                );
              }
            })(t.menus)),
            (r.tooltips = (function (t) {
              if (t || o || n) {
                var e = {};
                return (
                  (t = t || {}),
          ...
          if (e) {
            ...
            e.controlbar &&
              ...
              o.iconsActive &&
                ...
                r(['.jw-svg-icon-buffer'], 'fill', o.icons),
                (0, i.iv)(
              ...
              e.timeslider &&
                (function (t) {
                  ...
                  e &&
                    'none' !== e &&
                    (r(['.jw-progress'], 'background-color', e),
                    r(
                    ...
                    o &&
                      'none' !== o &&
                      r(['.jw-slider-time .jw-buffer'], 'background-color', o),
                    c &&
                      'none' !== c &&
                      r(
                    ...
                    s && 'none' !== s && r(['.jw-knob'], 'background-color', s),
                    n && 'none' !== n && r(['.jw-rail'], 'background-color', n),
                    r(
                      [
              ...
              e.tooltips &&
                (function (t) {
                  r(
                    ...
                    r(['.jw-time-tip', '.jw-tooltip'], 'color', t.background),
                    r(['.jw-skip'], 'border', 'none'),
                    r(
                      [
                        '.jw-skip .jw-text',
                        '.jw-skip .jw-icon',
              ...
              e.menus &&
                (function (e) {
                  if (e.textActive) {
                    ...
                    (0, i.iv)('#' + t + ' .jw-color-active', o, t),
                      (0, i.iv)(
                        '#' + t + ' .jw-color-active-hover:hover',
                        o,
                        t
                      );
                  }
                  if (e.text) {
                    ...
                    (0, i.iv)('#' + t + ' .jw-color-inactive', n, t),
                      (0, i.iv)(
                        '#' + t + ' .jw-color-inactive-hover:hover',
                        n,
                        t
                      );
                  }
    ...
    5545: function (t, e, o) {
      ...
      var n = o(7462),
        ...
        a = function (t, e) {
          ...
          var n = 'free' === o.edition,
            i = e.skinUrl;
          !n &&
            i &&
            (function (t, e) {
              (t.skin = {}), (t.skin.url = e), (t.skin.name = (0, r.FM)(e));
            })(o, i);
          var a = e.advertising || t.get('advertising'),
            l = e.adCustParams,
            u = a && a.schedule;
          l &&
        ...
        u = function (t) {
          if (t.source === window.parent) {
            ...
            if (
              e &&
              ('object' == typeof e ||
                ((e = JSON.parse(e)) && 'object' == typeof e))
            )
              return e;
          }
        },
        d = (function () {
          ...
          return (
            (e.setup = function (t) {
              ...
              return (
                this.subscribe(),
                this.sendMessage({ event: 'setup' }),
                (t.attributes.ampController = this),
                new Promise(function (o) {
                  var i = setTimeout(function () {
                      return (e.shouldSetupOnConfig = !0), o();
                    }, 50),
                    r = function (e) {
                      clearTimeout(i);
                      var s = u(e);
                      if (
                        s &&
                        'setupConfig' === s.method &&
                        'setupConfig' === s.method
                      ) {
                        window.removeEventListener('message', r);
                        var c = s.optParams;
                        if (!c || 0 === Object.keys(c).length) return o();
                        var l = a(t, c);
                        return this.shouldSetupOnConfig
                          ? void this.api.setup(
                              (0, n.Z)({}, this.api.getConfig().setupConfig, c)
                            )
                          : ((0, n.Z)(t.attributes, l), o());
                      }
                    }.bind(e);
            ...
            (e.getPlaylistItem = function () {
              var t = this.model.get('playlistItem');
              return this.createAMPItem(t);
            }),
            (e.getPlayedRanges = function () {
              for (
                var t = this.model.get('mediaElement').played,
                  e = t.length,
                  o = [],
                  n = 0;
                n < e;
                ...
                Object.keys(l).forEach(function (e) {
                  t.api.on(
                    ...
                    function (o) {
                      ...
                      n.client &&
                        'vast' === n.client &&
                        ['request', 'response'].forEach(function (t) {
                          delete n[t];
                        }),
                        t.sendMessage({ event: e, detail: n });
                    },
                    t
                  );
                }),
            ...
            (e.sendMessage = function (t, e) {
              void 0 === e && (e = '*'), window.parent.postMessage(t, e);
            }),
            (e.onCommand = function (t) {
              var e = this,
                o = u(t);
              if (o) {
                var n = o.method,
                  i = o.optParams;
                if ('getPlayedRanges' === n) {
                  var r = { ranges: this.getPlayedRanges() };
                  return this.sendMessage({ event: 'playedRanges', detail: r });
                }
                if (this.playerReady || 'setControls' !== n)
                  return this.api[n] ? this.api[n](i) : void 0;
                this.api.once('ready', function () {
                  e.api[n](i);
                });
              }
            ...
            (e.unsubscribe = function () {
              this.api && this.api.off(null, null, this),
                this.model && this.model.off(null, null, this),
                window.removeEventListener('message', this.onCommand);
            }),
            t
          );
        })();
