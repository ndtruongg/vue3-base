    ...
    2776: function (e, t, r) {
      ...
      v.prototype = {
        ...
        integer: function (e, t) {
          s.test(t) && this.set(e, parseInt(t, 10));
        },
        ...
        m = function (e, t, r) {
          var n = e,
            a = function () {
              ...
              return (e = e.replace(c, '')), t;
            },
            s = function () {
              e = e.replace(h, '');
            };
          if ((s(), (t.startTime = a()), s(), '--\x3e' !== e.substr(0, 3)))
            throw new Error(
          ...
          (e = e.substr(3)),
            ...
            (function (e, t) {
              var n = new v();
              !(function (e, t, r, n) {
                for (var a = n ? e.split(n) : [e], i = 0; i <= a.length; i += 1)
                  ...
                  switch (e) {
                    ...
                    case 'line':
                      ...
                      n.integer(e, s),
                        ...
                        n.alt(e, s, ['auto']),
                        2 === i.length &&
                          n.alt('lineAlign', i[1], ['start', T, 'end']);
                      break;
                    case 'position':
                      var u = t.split(',');
                      n.percent(e, u[0]),
                    ...
                    case 'size':
                      ...
                      break;
                    case 'align':
                      n.alt(e, t, ['start', T, 'end', 'left', 'right']);
                  }
                },
                l,
                f
      ...
      (b.prototype = {
        parse: function (e, t) {
          ...
          try {
            if ('INITIAL' === r.state) {
              if (!u.test(r.buffer)) return this;
              var f = (i = s()).match(d);
          ...
          !(function e() {
            try {
              for (; r.buffer && (p <= r.maxCueBatch || r.syncCueParsing); ) {
                if (!u.test(r.buffer)) return r.flush(), this;
                switch ((h ? (h = !1) : (i = s()), r.state)) {
                  case 'HEADER':
                    l.test(i) || i || (r.state = 'ID');
                    break;
                  case 'NOTE':
                    i || (r.state = 'ID');
                    break;
              ...
              if (((p = 0), r.buffer)) (0, n.U)(e);
              else if (!t) return r.flush(), this;
            } catch (e) {
              return c(), this;
            }
          })();
